        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Kilometars = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StarsRate = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "BookingCarAccessories",
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    CarAccessoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingCarAccessories", x => new { x.BookingId, x.CarAccessoryId });
                    table.ForeignKey(
                        name: "FK_BookingCarAccessories_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingCarAccessories_CarAccessories_CarAccessoryId",
                        column: x => x.CarAccessoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingCarAccessories_CarAccessoryId",
                table: "BookingCarAccessories",
